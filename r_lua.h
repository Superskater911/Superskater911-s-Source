...
#define r_lua_gettop(rL) (*(DWORD *)(rL + 8) - *(DWORD *)(rL + 12)) >> 4 //edit
...
making our own soon
*/
DWORD ADDRESS_PCALL = x(0x73F3E0);//edit
...
DWORD ADDRESS_TOUSERDATA = x(0x739830);//edit
...
rgetfield r_lua_getfield = (rgetfield)unprotect(x(0x73E630));//edit
typedef char*(__cdecl *rtolstring)(DWORD rL, int idx, size_t *size);
rtolstring r_lua_tolstring = (rtolstring)(unprotect(x(0x740960)));//edit
typedef void(__cdecl* rsettop)(DWORD rL, int idx);
rsettop r_lua_settop = (rsettop)(unprotect(x(0x740720)));//edit
typedef bool(__cdecl* toboolean)(DWORD rL, bool idx);
toboolean r_lua_toboolean = (toboolean)(x(0x741B90));//edit
typedef void(__cdecl* pushvalue)(DWORD rL, DWORD idx);
pushvalue r_lua_pushvalue = (pushvalue)(unprotect(x(0x73FA40)));//edit
typedef double(__stdcall* pushnumber)(DWORD rL, double idx);
pushnumber r_lua_pushnumber = (pushnumber)(unprotect(x(0x73F900)));//edit
typedef void(__fastcall* rpushstring)(DWORD rL, const char*);
rpushstring r_lua_pushstring = (rpushstring)(x(0x73F990));//edit
...
pushnil r_lua_pushnil = (pushnil)(unprotect(x(0x73F890)));//edit
typedef DWORD(__cdecl* next2)(DWORD rL, int idx);
next2 r_lua_next = (next2)(unprotect(x(0x73F260)));//edit
typedef bool(__cdecl* rboolean)(unsigned int, bool);
rboolean r_lua_pushboolean = (rboolean)(unprotect(x(0x73F4A0)));//edit
typedef double(__cdecl* rtonumber)(DWORD, int);
rtonumber r_lua_tonumber = (rtonumber)x(0x740C30);//edit
typedef void(__cdecl* rpushcclosure)(DWORD rL, int fn, int non);
rpushcclosure r_lua_pushcclosure = (rpushcclosure)(unprotect(x(0x73F520)));//edit
typedef void(__cdecl *rcreatetable)(DWORD rL, int num, int fix);
rcreatetable r_lua_createtable = (rcreatetable)(unprotect(x(0x73E2E0)));//edit
typedef void*(__cdecl *rnewuserdata)(DWORD rL, int idx);
rnewuserdata r_lua_newuserdata = (rnewuserdata)(unprotect(x(0x73F1A0)));//edit
typedef void*(__fastcall *rgetmetatable)(DWORD rL, int idx);
rgetmetatable r_lua_getmetatable = (rgetmetatable)(unprotect(x(0x740720)));//edit
typedef void*(__cdecl *rsettable)(DWORD rL, int);
rsettable r_lua_settable = (rsettable)(unprotect(x(0x741980)));//edit
typedef DWORD(__cdecl *rtype)(DWORD, int);
rtype r_lua_type = (rtype)(x(0x740D90));//edit
typedef DWORD(__cdecl *rgettop)(DWORD);
rgettop rlua_gettop = (rgettop)(x(0x73EB10));
typedef DWORD(__cdecl *rnewthread)(DWORD);
rnewthread r_lua_newthread = (rnewthread)unprotect(x(0x73F0B0));//edit
typedef void(__cdecl *rgetmetafield)(DWORD rL, const char*);
rgetmetafield r_lua_getmetafield = (rgetmetafield)(unprotect(x(0x7391B0)));//edit
typedef DWORD(__cdecl *rref)(DWORD, DWORD);
#include "retcheck.h"
rref r_luaL_ref = (rref)(Ret::unprotect<DWORD>((byte*)(x(0x739640))));//edit
typedef void(__stdcall *rrsetfield)(DWORD, int, const char*);
rrsetfield rlua_setfield2 = (rrsetfield)(unprotect(x(0x740350)));//edit
typedef void(__cdecl *rrawgeti)(DWORD, DWORD, DWORD);
rrawgeti r_lua_rawgeti = (rrawgeti)unprotect(x(0x73FCD0));//edit

typedef void(__cdecl *rpushlight)(DWORD, void*);
rpushlight r_lua_pushlightuserdata = (rpushlight)(unprotect(x(0x73F770)));//edit
